 ...
 *
 * @link              www.danielmakover.com
 * @since             1.0.0
 * @package           Wp_Cbf
 *
 * @wordpress-plugin
 * Plugin Name:       WP Cleanup and base functions
 * Plugin URI:        https://github.com/dmakius/wp_test
 * Description:       Head sections cleanup and many usual custom settings used on every website setup as image settings, privacy ad basic admin customisations
 * Version:           1.0.0
 * Author:            Daniel Makover
 * Author URI:        www.danielmakover.com
 * License:           GPL-2.0+
